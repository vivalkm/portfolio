...
function App() {
    return (
        <>
            ...
            <div className="mx-auto min-h-screen max-w-screen-xl px-6 py-12 font-sans md:px-12 md:py-0 lg:px-24 lg:py-0">
                <div className="md:flex md:justify-between md:gap-2 lg:gap-4">
